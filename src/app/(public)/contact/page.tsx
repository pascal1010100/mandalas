                            ...
                            <FadeIn>
                                <div className="relative backdrop-blur-2xl bg-stone-900/60 border border-white/5 rounded-3xl p-8 md:p-12 shadow-2xl shadow-black/50 overflow-hidden ring-1 ring-white/5">
                                    ...
                                    <form className="space-y-10">
                                        ...
                                        <div className="pt-4">
                                            <Button size="lg" className="w-full md:w-auto rounded-full px-12 py-8 text-lg font-medium tracking-wide bg-stone-100 text-stone-900 hover:bg-white hover:scale-[1.02] shadow-[0_0_20px_rgba(255,255,255,0.1)] border-0 transition-all duration-500">
                                                Enviar Mensaje
                                            </Button>
                                        </div>
                                    </form>
                            ...
                            <FadeIn delay={0.2}>
                                <div className="group p-8 py-10 bg-stone-900/40 backdrop-blur-sm border border-white/5 hover:bg-stone-900/60 hover:border-amber-500/20 transition-all duration-700 rounded-2xl relative overflow-hidden cursor-default">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-2xl text-stone-200 font-mono tracking-tighter hover:text-amber-200 transition-colors cursor-pointer">+502 1234 5678</p>
                                    </div>
                                </div>
                            </FadeIn>
                            ...
                            <FadeIn delay={0.3}>
                                <div className="group p-8 py-10 bg-stone-900/40 backdrop-blur-sm border border-white/5 hover:bg-stone-900/60 hover:border-lime-500/20 transition-all duration-700 rounded-2xl relative overflow-hidden cursor-default">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-lg text-stone-200 font-mono tracking-wide hover:text-lime-200 transition-colors cursor-pointer">info@mandalashostal.com</p>
                                    </div>
                                </div>
                            </FadeIn>
