...
## Hostelworld listing photos

The files in `hostelworld/` were sourced from Mandalas property listings on Hostelworld for layout review and website integration:

- `pueblo-exterior.jpg`
- `pueblo-lake-view.jpg`
- `pueblo-courtyard-hammock.jpg`
- `pueblo-stair-detail.jpg`
- `hideout-exterior-volcano.jpg`
- `hideout-terrace-dusk.jpg`
